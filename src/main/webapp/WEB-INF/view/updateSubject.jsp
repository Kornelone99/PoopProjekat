...
<body  style="background-color:#ebebeb;">
	...
	border:3px solid #3190cb;
      ...
      <form class="form-horizontal" method="POST" action="save-predmet" method="POST" action="save-predmet">
	<input type="hidden" name="id" value="${predmet.id }" />
      ...
      <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
          <button type="submit" class="btn btn-primary" style="margin:10px; background-color:#3190cb;">IZMENI</button>
        </div>
      </div>
    </form>
  </div>
